...
# set scalar coloring
ColorBy(output_3_Display, ('POINTS', 'IP_cell_desnity', 'Magnitude'))
...
iP_cell_desnityLUT.RescaleTransferFunction(20, 60)
...
# save animation
SaveAnimation(str(path_folder)+'/IP_Cell_desnity.avi', renderView1, ImageResolution=[2000, 1352],
