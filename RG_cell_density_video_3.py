...
rG_cell_desnityLUTColorBar.Position = [0.8036997126436782, 0.3197932053175776]
rG_cell_desnityLUTColorBar.ScalarBarLength = 0.3300000000000002

# change scalar bar placement
rG_cell_desnityLUTColorBar.Position = [0.7931633141762453, 0.31536189069423937]
...
rG_cell_desnityLUT.RescaleTransferFunction(20.0, 1000)

# Rescale transfer function
rG_cell_desnityPWF.RescaleTransferFunction(20.0, 1000)
...
# save animation
SaveAnimation(str(path_folder)+'/RG_Cell_desnity.avi', renderView1, ImageResolution=[2088, 1352],
