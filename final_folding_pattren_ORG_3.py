...
# set scalar coloring
ColorBy(clip1Display, ('POINTS', 'ORG_cell_desnity'))
ColorBy(clip2Display, ('POINTS', 'ORG_cell_desnity'))
...
oRG_cell_desnityLUTColorBar = GetScalarBar(oRG_cell_desnityLUT, renderView1)
oRG_cell_desnityLUTColorBar.Title = 'ORG_cell_desnity'
oRG_cell_desnityLUTColorBar.ComponentTitle = ''

# change scalar bar placement
oRG_cell_desnityLUTColorBar.WindowLocation = 'Any Location'
oRG_cell_desnityLUTColorBar.Position = [0.8036997126436782, 0.3197932053175776]
oRG_cell_desnityLUTColorBar.ScalarBarLength = 0.3300000000000002

# change scalar bar placement
oRG_cell_desnityLUTColorBar.Position = [0.7931633141762453, 0.31536189069423937]

# Rescale transfer function
oRG_cell_desnityLUT.RescaleTransferFunction(30.0, 300)

# Rescale transfer function
oRG_cell_desnityPWF.RescaleTransferFunction(30.0, 300)
...
# save screenshot
SaveScreenshot(str(path_folder)+'/ORG_folds_pattern.png', renderView1, ImageResolution=[2000, 1354],
