...
cell_desnityLUT.ApplyPreset('Blues', True)

# invert the transfer function
cell_desnityLUT.InvertTransferFunction()

# Rescale transfer function
cell_desnityLUT.RescaleTransferFunction(30, 150)
...
# save screenshot
SaveScreenshot(str(path_folder)+'/RG_folds_pattern.png', renderView1, ImageResolution=[2000, 1354],
